...
Main.start = function() {
	...
	client.on("ready",function(_) {
		Main.connected = true;
		haxe_Log.trace("" + Main.get_name() + " Ready!",{ fileName : "src/Main.hx", lineNumber : 25, className : "Main", methodName : "start"});
	});
	var rest = new discordjs_rest_REST({ "version" : "9"});
	rest.setToken(Main.config.discord_api_key);
	rest.put(Routes.applicationGuildCommands("661960123035418629","416069724158427137"),{ body : [{ name : "test1", description : "description test1"}]}).then(function(test) {
		haxe_Log.trace(test == null ? "null" : Std.string(test),{ fileName : "src/Main.hx", lineNumber : 31, className : "Main", methodName : "start"});
	},function(err) {
		haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 31, className : "Main", methodName : "start"});
	});
	client.on("interactionCreate",function(args) {
		haxe_Log.trace(args,{ fileName : "src/Main.hx", lineNumber : 34, className : "Main", methodName : "start"});
		args.reply("Pong").then(function(succ) {
			haxe_Log.trace(succ,{ fileName : "src/Main.hx", lineNumber : 35, className : "Main", methodName : "start"});
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 35, className : "Main", methodName : "start"});
		});
	});
	client.on("message",function(event) {
		haxe_Log.trace(event,{ fileName : "src/Main.hx", lineNumber : 38, className : "Main", methodName : "start"});
	});
	...
	client.login(Main.config.discord_api_key).then(function(_) {
		haxe_Log.trace("" + Main.get_name() + " logged in!",{ fileName : "src/Main.hx", lineNumber : 61, className : "Main", methodName : "start"});
	},function(error) {
		haxe_Log.trace("" + Main.get_name() + " Error!",{ fileName : "src/Main.hx", lineNumber : 63, className : "Main", methodName : "start"});
		haxe_Log.trace(error,{ fileName : "src/Main.hx", lineNumber : 64, className : "Main", methodName : "start"});
	});
